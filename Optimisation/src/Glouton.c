...
Color GP4_b_glouton(GameState* state, Color player, element* front){
    ...
    for (int i = 3 ; i <= 9 ; i++){
           ...
           // Copie pour ne pas modifier le vrai plateau et la liste des frontières
        ...
        GP4_b_copy_list(front, &front_copy) ;

        cases = 0 ;
        GP4_b_MAJ_plateau(&copy, player, &front_copy, i) ; //Modification de la copie
        ...
        GP4_b_supprime_liste(&front_copy) ;
    }  
